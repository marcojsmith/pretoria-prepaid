...
describe("users", () => {
  describe("getProfile", () => {
    ...
    it("returns profile for authenticated user", async () => {
      ...
      const result = await t.withIdentity({ subject: userId }).query(api.users.getProfile, {});
  ...
  describe("getRole", () => {
    ...
    it("returns 'user' default when no role record exists", async () => {
      ...
      const result = await t.withIdentity({ subject: userId }).query(api.users.getRole, {});
  ...
  describe("updatePushSubscription", () => {
    ...
    it("sets pushNotificationsEnabled and pushSubscription when subscription provided", async () => {
      ...
      await t.withIdentity({ subject: userId }).mutation(api.users.updatePushSubscription, {
