---
name: Better UI, Less AIslop
description: Guidance for building a clean, human-designed UI that avoids common AI-generated design patterns. Use when designing dashboards, landing pages, or any user interface to ensure it feels functional, honest, and free of generic AI aesthetics.
---
...
<div class="headline">
  ...
  <p>
    The layout stays strict and readable: live project health, team activity, and near-term
    priorities without the usual dashboard filler.
  </p>
</div>
```
